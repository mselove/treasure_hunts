...
% Check values of p from 0.01 to 15
% in increments of 0.01
p_grid = [1:1500]'./100;
...
current_best_percent = u_search(index_prof(index_prof2),index_prof2)./u_total(index_prof(index_prof2),index_prof2);
